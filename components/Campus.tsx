...
import { Search, MapPin, Users, Trophy, School, ArrowRight, Filter, Target, Flag, BookOpen, Star, Shield, TrendingUp, Globe, Map, Facebook, Briefcase } from 'lucide-react';
        ...
        <section className="py-20 bg-msl-black px-4 sm:px-6 lg:px-8 border-b border-white/10">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-[#0f172a] rounded-3xl p-8 border border-blue-900/30 flex flex-col md:flex-row gap-8 items-center relative overflow-hidden group">
                        ...
                        <div className="w-full md:w-1/3 aspect-square bg-blue-950/50 rounded-2xl flex items-center justify-center border border-blue-500/20 shadow-lg">
                    ...
                    <div className="space-y-6">
                        {/* Online Tournament */}
                        <div className="bg-msl-card p-6 rounded-2xl border border-white/10 hover:border-blue-500/30 transition-all">
                            <h4 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                <Globe size={18} className="text-blue-400" aria-hidden="true" /> Monthly Online Tournament
                            </h4>
                            <p className="text-sm text-gray-400 leading-relaxed">
                                Monthly online tournaments exclusively for student members. These campus-wide events allow registered students to compete remotely, fostering broad participation and an active, inclusive community.
                            </p>
                        </div>
                        ...
                        <div className="bg-msl-card p-6 rounded-2xl border border-white/10 hover:border-blue-500/30 transition-all">
                            <h4 className="text-lg font-bold text-white mb-2 flex items-center gap-2">
                                <Map size={18} className="text-msl-gold" aria-hidden="true" /> Monthly Onsite Tournament
                            </h4>
                            <p className="text-sm text-gray-400 leading-relaxed">
                                Regular offline tournaments held within campus premises or community venues. These in-person events build camaraderie, allow for face-to-face competition, and strengthen local engagement through live action.
                            </p>
                        </div>
                ...
                <div className="relative">
                    ...
                    <div className="flex overflow-x-auto gap-6 pb-8 snap-x scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
                        {REGIONAL_ADMINS.map((member, idx) => (
                            <div key={idx} className="min-w-[260px] max-w-[260px] snap-center bg-msl-card border border-white/5 rounded-xl overflow-hidden group hover:border-blue-500/30 transition-all">
                                ...
                                <div className="p-4">
                                    <p className="text-xs text-blue-400 font-bold uppercase tracking-wider mb-1 truncate">{member.region}</p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                    ...
                    <div className="w-full sm:w-auto overflow-x-auto pb-2 sm:pb-0 scrollbar-hide">
                        <div 
                            className="flex bg-msl-card rounded-xl p-1 border border-white/10 whitespace-nowrap min-w-full w-max"
                            role="radiogroup" 
