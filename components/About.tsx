...
const VALUES = [
    {
        ...
        desc: "We lead with honesty and fairness, doing what’s right even when no one is watching."
    },
    {
        icon: Clock,
        title: "Time as a Resource",
        desc: "We treat time like in-game energy—managing it wisely to balance academics, leadership, and growth."
    },
    {
        icon: Smile,
        title: "Leadership Through Friendliness",
        desc: "We build trust by being approachable, empathetic, and genuinely caring for our communities."
    },
    {
        icon: Zap,
        title: "Always Learning, Always Adapting",
        desc: "We embrace change and learn quickly to meet the evolving needs of our communities."
    },
    {
        icon: MessageCircle,
        title: "Responsiveness is Respect",
        desc: "We value trust by responding promptly and following through on our commitments to peers."
    },
    {
        icon: BookOpen,
        title: "Academic Excellence as a Standard",
        desc: "We are students first, proving we can excel in academics while leading in esports."
    },
    {
        icon: Heart,
        title: "Passion for MLBB and Community Growth",
        desc: "We use MLBB as a platform for connection, teamwork, and meaningful impact in schools."
    }
];
