...
const Partnerships: React.FC<PartnershipsProps> = ({ onNavigate }) => {
  ...
  const [partnerType, setPartnerType] = useState<'brand' | 'campus' | null>(null);
...
`}</style>
      ...
      <section id="contact" className="py-24 bg-msl-card px-4 sm:px-6 lg:px-8 border-t border-white/10">
        <div className="max-w-4xl mx-auto bg-black/40 border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
            ...
            {!partnerType ? (
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <button
                  ...
                  className="group relative p-8 rounded-3xl border border-white/10 bg-white/5 hover:bg-white/10 text-left transition-all hover:-translate-y-1 hover:border-msl-gold/50"
                >
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-msl-gold transition-colors">I am a Brand / Corporation</h3>
                  <p className="text-gray-400 text-sm">Looking to sponsor events, maximize brand visibility, or invest in the collegiate scene.</p>
                  <div className="mt-8 flex items-center gap-2 text-msl-gold font-bold text-sm">
                    Explore Opportunities <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                  </div>
                </button>

                <button
                  onClick={() => setPartnerType('campus')}
                  className="group relative p-8 rounded-3xl border border-white/10 bg-white/5 hover:bg-white/10 text-left transition-all hover:-translate-y-1 hover:border-blue-500/50"
                >
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-blue-400 transition-colors">I am a Campus Esports Org</h3>
                  <p className="text-gray-400 text-sm">Looking to join The MSL Network, get accredited, and receive diamond funding.</p>
              ...
              <div className="animate-fade-in text-center max-w-2xl mx-auto">
                <button
                  ...
                  className="mb-8 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm font-bold text-gray-400 hover:text-white hover:bg-white/10 transition-all flex items-center gap-2 mx-auto"
                >
                ...
                {partnerType === 'brand' ? (
                  <div className="space-y-6">
                    <div className="w-20 h-20 bg-purple-500/20 rounded-3xl flex items-center justify-center mx-auto border border-purple-500/20">
                      <Briefcase className="text-purple-400" size={40} />
                    </div>
                    <h3 className="text-3xl font-bold text-white">Let's Build Something Great.</h3>
                    <p className="text-gray-400 text-lg leading-relaxed">
                      Partner with us to amplify your brand across the collegiate scene.
                      Reach thousands of students and integrated directly into the gaming lifestyle.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                      <a
                        href="mailto:business@moonton.com"
                        className="px-8 py-4 bg-msl-gold hover:bg-msl-goldHover text-black rounded-xl font-bold text-lg shadow-[0_0_20px_rgba(242,194,26,0.3)] flex items-center justify-center gap-2 hover:scale-105 transition-all"
                      >
                        <Mail size={20} /> Email Us
                      </a>
                    </div>
                    <p className="text-xs text-gray-500 mt-4">Direct mail to: business@moonton.com</p>
                  </div>
                ) : (
                  <div className="space-y-6">
                    <div className="w-20 h-20 bg-blue-500/20 rounded-3xl flex items-center justify-center mx-auto border border-blue-500/20">
                      <Network className="text-blue-400" size={40} />
                    </div>
                    <h3 className="text-3xl font-bold text-white">Welcome to the Network.</h3>
                    <p className="text-gray-400 text-lg leading-relaxed">
                      Join the official ecosystem for student-gamers.
                      Get accredited, receive funding support, and connect with other leaders.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                      <button
                        onClick={() => { onNavigate('programs'); window.scrollTo(0, 0); }}
                        className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold text-lg shadow-[0_0_20px_rgba(37,99,235,0.3)] flex items-center justify-center gap-2 hover:scale-105 transition-all"
                      >
                        Apply Now <ArrowRight size={20} />
                      </button>
                    </div>
                    <p className="text-xs text-gray-500 mt-4">Redirects to The MSL Network programs page</p>
                  </div>
                )}
              </div>
            )}
