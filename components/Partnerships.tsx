            ...
            <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <label htmlFor="orgName" className="text-sm font-bold text-gray-300 ml-1">Organization / Company Name</label>
                        <input id="orgName" type="text" placeholder="e.g. Teletigers Esports or Logitech" className="w-full px-5 py-3 bg-msl-card border border-white/10 rounded-xl text-white focus:outline-none focus:border-msl-gold transition-colors" required />
                    </div>
                    <div className="space-y-2">
                        <label htmlFor="contactPerson" className="text-sm font-bold text-gray-300 ml-1">Contact Person</label>
                        <input id="contactPerson" type="text" placeholder="Full Name" className="w-full px-5 py-3 bg-msl-card border border-white/10 rounded-xl text-white focus:outline-none focus:border-msl-gold transition-colors" required />
                    </div>
                </div>
                
                <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-bold text-gray-300 ml-1">Email Address</label>
                    <input id="email" type="email" placeholder="email@address.com" className="w-full px-5 py-3 bg-msl-card border border-white/10 rounded-xl text-white focus:outline-none focus:border-msl-gold transition-colors" required />
                </div>

                <div className="space-y-2">
                    <label htmlFor="inquiryType" className="text-sm font-bold text-gray-300 ml-1">Inquiry Type</label>
                    <select id="inquiryType" className="w-full px-5 py-3 bg-msl-card border border-white/10 rounded-xl text-gray-300 focus:outline-none focus:border-msl-gold transition-colors">
                        <option>Joining The MSL Network (School Org)</option>
                        <option>Corporate Sponsorship</option>
                        <option>Buffs & Support Inquiry</option>
                        <option>Other</option>
                    </select>
                </div>

                <div className="space-y-2">
                    <label htmlFor="message" className="text-sm font-bold text-gray-300 ml-1">Message</label>
                    <textarea id="message" rows={4} placeholder="How can we collaborate?" className="w-full px-5 py-3 bg-msl-card border border-white/10 rounded-xl text-white focus:outline-none focus:border-msl-gold transition-colors" required></textarea>
                </div>
                ...
                <div className="flex items-start gap-3 pt-2">
                    <input 
                        id="dpa-consent" 
                        type="checkbox" 
                        className="mt-1 w-4 h-4 rounded border-gray-600 text-msl-gold focus:ring-msl-gold bg-black/50" 
                        required 
                    />
                    <label htmlFor="dpa-consent" className="text-xs text-gray-400">
                        By submitting this form, I consent to the collection and processing of my personal data by MSL Philippines in accordance with the <strong>Data Privacy Act of 2012</strong>. I understand that my data will be used solely for partnership inquiries.
                    </label>
                </div>

                <button className="w-full py-4 bg-msl-gold hover:bg-msl-goldHover text-black font-bold text-lg rounded-xl shadow-lg transition-all flex items-center justify-center gap-2">
