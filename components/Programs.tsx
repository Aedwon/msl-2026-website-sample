...
const Programs: React.FC = () => {
  ...
  const handleViewAllClick = () => {
    if (activeRegion !== 'All') {
        ...
        alert("Redirecting to the full Campus Tournament Archive...");
    }
  };
                    ...
                    {CORE_PROGRAMS.map((prog, idx) => (
                        <div key={idx} className="group relative bg-msl-card rounded-3xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-300 flex flex-col h-full">
                            ...
                            <div className="p-8 flex flex-col flex-grow">
                                ...
                                <button className="w-full py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl font-bold flex items-center justify-center gap-2 transition-all">
